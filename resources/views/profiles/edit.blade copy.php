...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="input-group-prepend">
      <label  class="input-group-text g-bg-white" for="name"><i style="padding: 0 5px" class="icon-finance-067 u-line-icon-pro g-pos-rel g-top-1 g-mr-5 g-color-gray-dark-v5"></i> Title</label>
    </div>
    <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title') ?? $user->profile->title }}" required autocomplete="title" autofocus >
          ...
          <div class="input-group g-mb-25 col-md-12 mt-2">
    <div class="input-group-prepend">
      <label  class="input-group-text g-bg-white" for="description"><i style="padding: 0 5px" class="icon-tag g-pos-rel g-top-1 g-mr-5 g-color-gray-dark-v5"></i> Description</label>
    </div>
    ...
    <div class="form-group row">     
          <div class="input-group g-mb-25 col-md-12 mt-2">
    <div class="input-group-prepend">
      <label  class="input-group-text g-bg-white" for="url"><i style="padding: 0 5px" class="icon-link g-pos-rel g-top-1 g-mr-5 g-color-gray-dark-v5"></i> URL</label>
    </div>
          ...
          <div class="input-group g-mb-25 col-md-12 mt-2">
    <div class="input-group-prepend">
      <label  class="input-group-text g-bg-white" for="function"><i style="padding: 0 5px" class="icon-badge g-pos-rel g-top-1 g-mr-5 g-color-gray-dark-v5"></i> Function</label>
    </div>
  ...
  <div class="form-group row">     
          <div class="input-group g-mb-25 col-md-12 mt-2">
    <div class="input-group-prepend">
      <label  class="input-group-text g-bg-white" for="company"><i style="padding: 0 5px" class="icon-real-estate-066 u-line-icon-pro g-pos-rel g-top-1 g-mr-5 g-color-gray-dark-v5"></i> Company</label>
    </div>
...
<div class="form-group row">     
          <div class="input-group g-mb-25 col-md-12 mt-2">
    <div class="input-group-prepend">
      <label  class="input-group-text g-bg-white" for="company"><i style="padding: 0 5px" class="icon-real-estate-020 u-line-icon-pro"></i> Location</label>
    </div>
...
<div class="form-group mb-0">
                  ...
                  <div class="jFiler"><input class="js-file-attachment" type="file" name="fileAttachment2[]" multiple="multiple" style="position: absolute; left: -9999px; top: -9999px; z-index: -9999;"><div class="u-file-attach-v3 g-mb-15">                            <h3 class="g-font-size-16 g-color-gray-dark-v2 mb-0">Drop files here or <span class="g-color-primary">Browse your device</span></h3>                            <p class="g-font-size-14 g-color-gray-light-v2 mb-0">Maximum file size 10mb</p>                         </div></div>
                </div>
    ...
    <div class="col-md-4 offset-2">
      ...
      <div class="form-group row">     
          <div class="input-group g-mb-25 col-md-12 mt-2">
    <div class="input-group-prepend">
      <label  class="input-group-text g-bg-white" for="facebook"><i style="padding: 0 5px" class="icon-social-facebook g-pos-rel g-top-1 g-mr-5 g-color-gray-dark-v5"></i> Facebook</label>
    </div>
          ...
          <div class="input-group g-mb-25 col-md-12 mt-2">
    <div class="input-group-prepend">
      <label  class="input-group-text g-bg-white" for="instagram"><i style="padding: 0 5px" class="icon-social-instagram g-pos-rel g-top-1 g-mr-5 g-color-gray-dark-v5"></i> Instagram</label>
    </div>
          ...
          <div class="input-group g-mb-25 col-md-12 mt-2">
    <div class="input-group-prepend">
      <label  class="input-group-text g-bg-white" for="twitter"><i style="padding: 0 5px" class="icon-social-twitter g-pos-rel g-top-1 g-mr-5 g-color-gray-dark-v5"></i> Twitter</label>
    </div>
          ...
          <div class="input-group g-mb-25 col-md-12 mt-2">
    <div class="input-group-prepend">
      <label  class="input-group-text g-bg-white" for="pinterest"><i style="padding: 0 5px" class="icon-social-pinterest g-pos-rel g-top-1 g-mr-5 g-color-gray-dark-v5"></i> Pinterest</label>
    </div>
