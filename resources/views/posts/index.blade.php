 ...
 <!-- Footer -->
      <footer class="g-bg-secondary">
       <div class="g-brd-bottom g-brd-secondary-light-v2 g-py-20 ">
          <div class="container">
            <h3 class="h6 g-font-primary g-font-weight-700 text-uppercase mb-3">Latest users.Wanna meet them?</h3>
  ...
  <div class="col-md-4 g-mb-30">
    <!-- Figure -->
    <figure class="u-info-v7-1 u-info-v7-1__item g-bg-white g-rounded-4 text-center">
      <div class="g-py-40 g-px-20">
        <!-- Figure Image -->
          @if(!empty($user->profile->image) )
        <a href="/profile/{{$user->id}}"><img style="left: 55px;position: relative;" class="u-info-v7-1__item-child-v1 g-width-100 g-height-100 rounded-circle g-mb-20" src="/storage/{{ $user->profile->image }}"  alt="Image Description"></a>
        @else
        <a href="/profile/{{$user->id}}"><img style="left: 55px;position: relative;" class="u-info-v7-1__item-child-v1 g-width-100 g-height-100 rounded-circle g-mb-20" src="/storage/profile/vx2k9TEhkcgaRdOWKvs4lsxqOVmuzwumtwySEnvH.png"  alt="Image Description"></a>
@endif

        <!-- Figure Image -->

        <!-- Figure Info -->
        <h4 class="h5 g-mb-5">{{$user->username}}</h4>
        <div class="d-block">
          ...
          <em class="g-color-gray-dark-v4 g-font-style-normal g-font-size-default">{{$user->profile->function}}</em>
          @endif
          
        </div>
         @if(!empty($user->profile->title))
          <span class="g-color-cyan g-font-size-default g-mr-3">
            <i class="icon-finance-067 u-line-icon-pro g-pos-rel g-top-1 g-mr-5 g-color-gray-dark-v5"></i>
          </span>
        
          <em class="g-color-gray-dark-v4 g-font-style-normal g-font-size-default">{{$user->profile->title}}</em>
          @endif
        <!-- End Figure Info -->
      </div>
<ul class="list-inline mb-0">
                      ...
                      <li class="list-inline-item g-mx-2">
                        <a class="u-icon-v1 u-icon-size--sm u-icon-slide-up--hover g-color-gray-light-v1 g-bg-gray-light-v5 g-color-gray-light-v1--hover rounded-circle" href="{{ $user->profile->facebook }}">
                      ...
                      <li class="list-inline-item g-mx-2">
                        <a class="u-icon-v1 u-icon-size--sm u-icon-slide-up--hover g-color-gray-light-v1 g-bg-gray-light-v5 g-color-gray-light-v1--hover rounded-circle" href="{{ $user->profile->instagram }}" target="_blank">
                      ...
                      <li class="list-inline-item g-mx-2">
                        <a class="u-icon-v1 u-icon-size--sm u-icon-slide-up--hover g-color-gray-light-v1 g-bg-gray-light-v5 g-color-gray-light-v1--hover rounded-circle" href="{{ $user->profile->twitter }}">
                      ...
                      <li class="list-inline-item g-mx-2">
                        <a class="u-icon-v1 u-icon-size--sm u-icon-slide-up--hover g-color-gray-light-v1 g-bg-gray-light-v5 g-color-gray-light-v1--hover rounded-circle" href="{{ $user->profile->pinterest }}">
      ...
      <ul class="row list-inline g-py-20 g-ma-0">
        ...
        <li class="col g-brd-right g-brd-gray-light-v4">
          <a class="u-icon-v1 u-icon-size--sm g-color-gray-dark-v5 g-bg-transparent g-color-red--hover" href="/profile/{{$user->id}}">
            <i class="icon-user"></i>
          </a>
        </li>
        <li class="col ">
        ...
        @if(!empty($user->profile->url))
         <li class="col g-brd-left g-brd-gray-light-v4">
          <a class="u-icon-v1 u-icon-size--sm g-color-gray-dark-v5 g-bg-transparent g-color-blue--hover" href="{{$user->profile->url}}" target="_blank">
            <i class="icon-globe u-line-icon-pro"></i>
          </a>
        </li>
        @endif
      </ul>
 ...
 <div class="col-lg-4 g-mb-30">
    ...
    <figure class="u-shadow-v19 g-bg-white g-rounded-4 g-pa-20">
      <div class="d-flex justify-content-start">
        <!-- Figure Image -->
        <a href="/profile/{{$post->user->id}}"> <img class="g-width-50 g-height-50 rounded-circle g-mr-15" src="/storage/{{ $post->user->profile->image }}" alt="Image Description"></a>
        <!-- Figure Image -->

        <div class="d-block">
          <!-- Figure Info -->
          <div class="g-mb-5">
            <h4 class="h5 g-mb-1"><a href="/profile/{{$post->user->id}}">{{ $post->user->username }}</a></h4>
          ...
          <ul class="list-inline mb-0">
            @if(!empty($user->profile->facebook))
            <li class="list-inline-item g-mx-2">
              <a class="u-icon-v1 u-icon-slide-up--hover g-color-gray-dark-v4 g-color-facebook--hover g-ml-minus-15" href="{{$user->profile->facebook}}">
            ...
            @endif
             @if(!empty($user->profile->instagram))
            <li class="list-inline-item g-mx-2">
              <a class="u-icon-v1 u-icon-slide-up--hover g-color-gray-dark-v4 g-color-instagram--hover" href="{{$user->profile->instagram}}">
            ...
            @if(!empty($user->profile->twitter))
            <li class="list-inline-item g-mx-2">
              <a class="u-icon-v1 u-icon-slide-up--hover g-color-gray-dark-v4 g-color-twitter--hover" href="{{$user->profile->twitter}}">
            ...
            @endif
             ...
             @if(!empty($user->profile->pinterest))
            <li class="list-inline-item g-mx-2">
              <a class="u-icon-v1 u-icon-slide-up--hover g-color-gray-dark-v4 g-color-instagram--hover" href="{{$user->profile->pinterest}}">
      ...
      <div class="d-flex justify-content-start">
        <!-- Figure Image -->
        <a href="/post/{{$post->id}}"><img class="g-width-50 g-height-50 rounded-circle g-mr-15" src="/storage/{{ $post->image }}" alt="Image Description"></a>
        <!-- Figure Image -->
        ...
        <div class="d-block">
          ...
          <div class="g-mb-5">
            <h3 class="h6 g-font-weight-600 mb-1">
              <a class="g-color-black g-color-primary--hover" href="/post/{{$post->id}}">{{$post->caption}}</a>
            </h3>
